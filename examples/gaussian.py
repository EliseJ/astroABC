...
def main():
        ...
        #make some fake data
        data = Model(model_type,nsamples).make_mock(param, var=np.array([0.01, 0.005, 0.005, 0.1]))
...
if __name__ == "__main__":
        ...
        'pert_kernel':pconfig.pert_kernel,'variance_method':pconfig.var_method, 'dist_type': pconfig.dist_type,
        'dfunc':dist_metric, 'restart':restartF, 'outfile':outF,'mpi':pconfig.mpi,'mp':pconfig.mp,'num_proc':num_proc,
        'from_restart':pconfig.from_restart}
